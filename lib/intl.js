...
exports.LocaleContextProvider = undefined;
...
var translate = function translate(local) {
...
var LocaleContextProvider = exports.LocaleContextProvider = function (_React$PureComponent) {
  _inherits(LocaleContextProvider, _React$PureComponent);

  function LocaleContextProvider(props) {
    _classCallCheck(this, LocaleContextProvider);

    var _this = _possibleConstructorReturn(this, (LocaleContextProvider.__proto__ || Object.getPrototypeOf(LocaleContextProvider)).call(this, props));
  ...
  _createClass(LocaleContextProvider, [{
