...
mva.onError = function() {
  ...
  (_global_dva_app2 = global_dva_app).onError.apply(
    _global_dva_app2,
    arguments
  );
  return mva;
...
mva.onAction = function() {
  ...
  (_global_dva_app3 = global_dva_app).onAction.apply(
    _global_dva_app3,
    arguments
  );
  return mva;
...
mva.onStateChange = function() {
  ...
  (_global_dva_app4 = global_dva_app).onStateChange.apply(
    _global_dva_app4,
    arguments
  );
  return mva;
...
mva.onEffect = function() {
  ...
  (_global_dva_app5 = global_dva_app).onEffect.apply(
    _global_dva_app5,
    arguments
  );
  return mva;
