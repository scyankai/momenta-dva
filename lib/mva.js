...
mva.start = function () {
	...
	(_global_dva_app = global_dva_app).start.apply(_global_dva_app, arguments);
	return mva;
};
...
mva.use = function () {
	...
	(_global_dva_app2 = global_dva_app).use.apply(_global_dva_app2, arguments);
	return mva;
};
...
mva.onError = function () {
	...
	(_global_dva_app3 = global_dva_app).onError.apply(_global_dva_app3, arguments);
	return mva;
};
...
mva.onAction = function () {
	...
	(_global_dva_app4 = global_dva_app).onAction.apply(_global_dva_app4, arguments);
	return mva;
};
...
mva.onStateChange = function () {
	...
	(_global_dva_app5 = global_dva_app).onStateChange.apply(_global_dva_app5, arguments);
	return mva;
};
...
mva.onEffect = function () {
	...
	(_global_dva_app6 = global_dva_app).onEffect.apply(_global_dva_app6, arguments);
	return mva;
};
...
mva.onHmr = function () {
	...
	(_global_dva_app7 = global_dva_app).onHmr.apply(_global_dva_app7, arguments);
	return mva;
};

mva.model = function (model) {
	var exist = global_dva_app._models.some(function (_ref) {
